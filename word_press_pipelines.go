...
func (xc *XilutionClient) CreateWordPressPipeline(organizationId *string, wordPress *WordPressPipeline) (*string, error) {
	...
	req, _ := retryablehttp.NewRequest("POST", fmt.Sprintf("%s/organizations/%s/pipelines", PenguinBaseUrl, *organizationId), strings.NewReader(string(rb)))
...
func (xc *XilutionClient) GetWordPressPipeline(organizationId *string, wordPressId *string) (*WordPressPipeline, error) {
	req, _ := retryablehttp.NewRequest("GET", fmt.Sprintf("%s/organizations/%s/pipelines/%s", PenguinBaseUrl, *organizationId, *wordPressId), nil)
...
func (xc *XilutionClient) GetWordPressPipelines(organizationId *string, pageSize, pageNumber *int) (*FetchWordPressPipelinesResponse, error) {
	req, _ := retryablehttp.NewRequest("GET", fmt.Sprintf("%s/organizations/%s/pipelines?pageSize=%d&pageNumber=%d", PenguinBaseUrl, *organizationId, *pageSize, *pageNumber), nil)
...
func (xc *XilutionClient) UpdateWordPressPipeline(organizationId *string, wordPress *WordPressPipeline) error {
	...
	req, _ := retryablehttp.NewRequest("PUT", fmt.Sprintf("%s/organizations/%s/pipelines/%s", PenguinBaseUrl, *organizationId, wordPress.ID), strings.NewReader(string(rb)))
...
func (xc *XilutionClient) DeleteWordPressPipeline(organizationId *string, wordPressId *string) error {
	req, _ := retryablehttp.NewRequest("DELETE", fmt.Sprintf("%s/organizations/%s/pipelines/%s", PenguinBaseUrl, *organizationId, *wordPressId), strings.NewReader(string("")))
